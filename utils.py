...
def save_model_oa(args, epoch, model, optimizer):
    output_dir = Path(args.output_dir)
    # epoch_name = str(epoch)
    checkpoint_paths = [output_dir / ('checkpoint-OA.pth')]
    for checkpoint_path in checkpoint_paths:
        to_save = {
            'model': model.state_dict(),
            'optimizer': optimizer.state_dict(),
...
def save_model_aa(args, epoch, model, optimizer):
    output_dir = Path(args.output_dir)
    # epoch_name = str(epoch)
    checkpoint_paths = [output_dir / ('checkpoint-AA.pth')]
    for checkpoint_path in checkpoint_paths:
        to_save = {
            'model': model.state_dict(),
            'optimizer': optimizer.state_dict(),
...
def save_model_kp(args, epoch, model, optimizer):
    output_dir = Path(args.output_dir)
    # epoch_name = str(epoch)
    checkpoint_paths = [output_dir / ('checkpoint-KP.pth')]
    for checkpoint_path in checkpoint_paths:
        to_save = {
            'model': model.state_dict(),
            'optimizer': optimizer.state_dict(),
